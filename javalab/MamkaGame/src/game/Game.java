...
//    private static Game game_gamer;
//    private GameField game_field;
//    public static void main(String[] args) {
//	game_gamer = new Game ();
//	game_gamer.setDefaultCloseOperation(WindowConstants. EXIT_ON_CLOSE);
//	game_gamer.setLocation (200, 50) ;
//	game_gamer.setSize (900, 600);
//	game_gamer.setResizable(false);
//	game_gamer.game_field = new GameField();
//	game_gamer.add(game_gamer.game_field);
//	game_gamer.setVisible (true);
//	
//
//    }
//
...
public class Game extends JFrame {
    ...
    public static void main(String[] args) throws IOException {
        papich = ImageIO.read(Game.class.getResourceAsStream("supersus.jpg"));
        nuts = ImageIO.read(Game.class.getResourceAsStream("zolo4.jpg"));
        end = ImageIO.read(Game.class.getResourceAsStream("zolo5.jpg"));
        game_game = new Game();
